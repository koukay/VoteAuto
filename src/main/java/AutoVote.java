...
public class AutoVote {
    ...
    public static void main(String[] args) throws InterruptedException {
        for (int i = 0; i < 2; i++) {
            ...
            driver.get("https://jinshuju.net/f/Y5dpph");

            Thread.sleep(1000);
            //选中18号  浏览器右击查看元素,可以复制 xpath
            driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/form/div[3]/div/div[2]/div/div[2]/div/div/span/div/div[18]/div/div/label/span[1]"))
                    .click();
            Thread.sleep(5000);
            //投票
