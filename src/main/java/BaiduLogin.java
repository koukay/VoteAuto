...
//        WebDriver driver = new FirefoxDriver();
        System.setProperty("webdriver.chrome.driver", "D:\\tools\\Vote\\Vote\\chromedriver.exe");
      ...
      driver.manage().window().maximize();
        ...
        driver.findElement(By.xpath("//*[@id='u']")).sendKeys("user");
        driver.findElement(By.xpath("//*[@id='p']")).sendKeys("pwd");
